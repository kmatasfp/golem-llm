...
impl GuestGraph for Graph {
    fn begin_transaction(&self) -> Result<TransactionResource, GraphError> {
        ...
        let common_collections = vec![
            ("Person", golem_graph::golem::graph::schema::ContainerType::VertexContainer),
            ("TempUser", golem_graph::golem::graph::schema::ContainerType::VertexContainer),
            ...
            ("KNOWS", golem_graph::golem::graph::schema::ContainerType::EdgeContainer),
            ("WORKS_FOR", golem_graph::golem::graph::schema::ContainerType::EdgeContainer),
            ("CONNECTS", golem_graph::golem::graph::schema::ContainerType::EdgeContainer),
            ("FOLLOWS", golem_graph::golem::graph::schema::ContainerType::EdgeContainer),
        ];
